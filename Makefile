...
clean :
	rm -f rrSnapshot rrPersistent rrChained bfsPersistent bfsChained bfsSnapshot bfsInterval Interval.o TemporalEdge.o TemporalNode.o TemporalGraph.o Stop.o
